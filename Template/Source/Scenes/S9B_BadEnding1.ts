    ...
    export async function S9B_BadEnding1(): ƒS.SceneReturn {
        ...
        let text = { // Charaktere Texte
            narrator: {
                ...
                T0001: "<p> Safe and sound " + dataForSave.nameProtagonist + " stood hidden <br> while the screaming ant got bitten. <br> The crow swallowed it with a crunch. <br> as the seed broke down in a hunch. </p>",
